$(document).ready(function () {
  function handleScrollAnimations() {
    ...
    $(
      ".contact-text, .contact-buttons, .contact-details, .contact-image, .contact-info, .basic-plan, .standard-plan, .premium-plan, .left-column, .right-column, .text-plans, .trimite"
    ).each(function () {
      ...
      let delay = 100;
      if (
        distanceFromBottom < -delay &&
        !$(this).hasClass("animate__animated")
      ) {
...
$(document).ready(function () {
  ...
  $("#adress").click(function () {
    window.location.href =
      "https://maps.google.com/?q=Str. Sfanta Vineri, nr. 16";
  });
});
...
$(document).ready(function () {
  function updateImages() {
    ...
    let imageSrcMap = {
      ectomorf: {
        "<80": {
          front: "./assets/body types/XS.png",
          side: "./assets/body types/XS Side.png",
          type: "XS",
        },
        "80-90": {
          front: "./assets/body types/S.png",
          side: "./assets/body types/S Side.png",
          type: "S",
        },
        ">=90": {
          front: "./assets/body types/M.png",
          side: "./assets/body types/M Side.png",
          type: "M",
        },
      },
      mezomorf: {
      ...
      endomorf: {
        ...
        ">=80": {
          front: "./assets/body types/L.png",
          side: "./assets/body types/L Side.png",
          type: "L",
        },
      },
      above150: {
  ...
  $("#tip_somatic, #greutate, #zile_saptamana, #frecventa_antrenament").on(
    "input change",
    updateImages
  );
  ...
  if (localStorage.getItem("frecventa_antrenament")) {
    $("#frecventa_antrenament").val(
      localStorage.getItem("frecventa_antrenament")
    );
  }
  updateImages();
});
